        ...
        <div className="container mx-auto px-4">
          <div className="lg:col-gap-12 xl:col-gap-16  grid grid-cols-1 gap-12  lg:grid-cols-5 lg:gap-16">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="mt-8 border-t border-gray-300 pt-8 flow-root">
                <h2 className="text-2xl font-bold mb-4">Pickup Location</h2>
                <div className="h-[300px] w-full rounded-xl overflow-hidden drop-shadow-md z-0 relative">
                  <MapContainer center={[12.9716, 77.5946]} zoom={13} scrollWheelZoom={false} style={{ height: '100%', width: '100%', zIndex: 0 }}>
                    <TileLayer
                    ...
                    <Marker position={[12.9716, 77.5946]}>
                      <Popup>
                        {singleVehicleDetail.name} <br /> {singleVehicleDetail.company}
                      </Popup>
                    </Marker>
                  </MapContainer>
                </div>
