...
import { getAllUsers, getAllVendors, deleteUserByAdmin } from "../controllers/adminControllers/adminManagementController.js"
...
router.delete('/deleteUser/:id', verifyToken, deleteUserByAdmin)
