...
import { setData, setFilteredData, setPriceHightoLow, setPriceLowtoHigh, setYearAscending, setYearDecending, setRatingHighToLow } from "../redux/user/sortfilterSlice";
        ...
        <div className="flex items-center justify-center gap-1 md:gap-3 md:justify-start mx-auto md:mx-[80px] lg:mx-0">
            ...
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  <MenuItem className="bg-gray-100" >None</MenuItem>
                  <MenuItem value={"ratingHighToLow"}>Top Rated</MenuItem>
                </TextField>
              )}
            ></Controller>
