        ...
        <>
          <div className="flex justify-between items-center">
            <Link
              to={`/`}
              onClick={() => {}}
              className="items-center flex gap-3 mt-8 ml-4 text-3xl font-black text-slate-900 tracking-tighter"
            >
              Tripyra
            </Link>
            {/* hide sidebar button */}
          ...
          <div className="mt-10">
            ...
            <div className="flex flex-col gap-y-5">
              ...
              <div className="flex items-center mt-10 gap-2 pb-10">
                <button
                  type="button"
                  className="ml-4 text-slate-400 font-bold hover:text-red-500 transition-colors"
                  onClick={handleSignout}
                >
                  Sign Out
                </button>
                <CiLogout className="text-slate-400" />
              </div>
